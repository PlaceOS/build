...
OptionParser.parse(ARGV.dup) do |parser|
  ...
  parser.on("-v", "--version", "Display the application version") do
    puts "#{PlaceOS::Build::APP_NAME} v#{PlaceOS::Build::VERSION}"
    exit 0
  end
...
# Load the routes
puts "Launching #{PlaceOS::Build::APP_NAME} v#{PlaceOS::Build::VERSION} (#{PlaceOS::Build::BUILD_COMMIT} @ #{PlaceOS::Build::BUILD_TIME.strip})"
...
# Shutdown message
puts "#{PlaceOS::Build::APP_NAME} leaps through the veldt\n"
